...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    try {
      ...
      const attachment = new AttachmentBuilder(canvas.toBuffer('image/png'), { name: 'araniyor.png' });
      ...
      await interaction.editReply({ content: `Poster oluşturulurken bir hata oluştu! Lütfen tekrar deneyin.` });
    }
  }
};
